src/debugger/Debugger.o: src/debugger/Debugger.cxx \
  src/emucore/m6502/src/bspf/src/bspf.hxx src/common/Version.hxx \
  src/emucore/OSystem.hxx src/common/Array.hxx \
  src/emucore/m6502/src/bspf/src/bspf.hxx src/emucore/EventHandler.hxx \
  ...
  src/emucore/Settings.hxx src/debugger/gui/DebuggerDialog.hxx \
  ...
  src/gui/GuiObject.hxx src/emucore/OSystem.hxx src/gui/Rect.hxx \
  src/debugger/gui/PromptWidget.hxx src/gui/GuiObject.hxx \
  src/gui/Widget.hxx src/gui/Command.hxx \
  src/emucore/m6502/src/bspf/src/bspf.hxx src/debugger/DebuggerParser.hxx \
  src/common/Array.hxx src/emucore/StateManager.hxx \
  ...
  src/emucore/AtariVox.hxx src/emucore/m6502/src/System.hxx \
  ...
  src/common/Array.hxx src/gui/StringList.hxx src/debugger/EquateList.hxx \
  src/debugger/Equate.hxx src/debugger/CpuDebug.hxx \
  src/debugger/DebuggerSystem.hxx src/debugger/Debugger.hxx \
  src/gui/DialogContainer.hxx src/emucore/EventHandler.hxx \
  src/gui/Stack.hxx src/debugger/PackedBitArray.hxx \
  src/debugger/gui/PromptWidget.hxx src/gui/Rect.hxx \
  src/debugger/RamDebug.hxx src/debugger/TIADebug.hxx \
  src/debugger/gui/TiaInfoWidget.hxx src/debugger/gui/TiaOutputWidget.hxx \
  src/debugger/gui/TiaZoomWidget.hxx src/gui/EditTextWidget.hxx \
  src/gui/EditableWidget.hxx src/debugger/gui/RomWidget.hxx \
  src/common/Array.hxx src/debugger/Expression.hxx \
  src/yacc/YaccParser.hxx src/debugger/Expression.hxx
...
src/debugger/gui/DebuggerDialog.hxx:
...
src/debugger/gui/PromptWidget.hxx:
...
src/debugger/EquateList.hxx:

src/debugger/Equate.hxx:

src/debugger/CpuDebug.hxx:

src/debugger/DebuggerSystem.hxx:
...
src/debugger/RamDebug.hxx:

src/debugger/TIADebug.hxx:

src/debugger/gui/TiaInfoWidget.hxx:

src/debugger/gui/TiaOutputWidget.hxx:

src/debugger/gui/TiaZoomWidget.hxx:
...
src/debugger/Expression.hxx:

src/yacc/YaccParser.hxx:
